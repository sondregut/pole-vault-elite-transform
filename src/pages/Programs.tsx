...
const Programs = () => {
  ...
  const featuredPrograms = [
    ...
    },
    {
      ...
      description: "10-week strength-focused program to develop explosive power and athleticism. Integrates seamlessly with pole vault or sport-specific training.",
      features: [
      ...
      duration: "10 weeks",
      level: "All levels",
      timeCommitment: "2-3 sessions/week",
      price: "$39",
      priceDetail: "One-time purchase",
