export const products = [
  {
    ...
    hasOptions: false,
    options: [],
    description: "A 10-week weightlifting program designed to transform your performance through expert programming. Build explosive power and athleticism with 2-3 sessions per week, combining Olympic lifts, compound movements, and accessory exercises. Delivered through TrainHeroic with lifetime access."
  },
  {
    id: 2,
